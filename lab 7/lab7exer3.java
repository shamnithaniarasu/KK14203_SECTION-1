...
class FormPanel extends JPanel implements ActionListener, ItemListener{
   ...
   public FormPanel(){   
      ...
      String[] courses={"[Select]", "KP14203 Object-Orineted Organisation", "UC01002 Corporate Communication"};
    ...
    public void writeInput(){
      ...
      //exception implementation
		try {
			...
			pr.println(input);
         JOptionPane.showMessageDialog(null, "Input is saved.");
		} catch (IOException e) {			
